...
foreach ($xml->div->div->div as $chapter)
{
	...
	foreach ($chapter->div as $section)
	{
        ...
        echo "<li><a class=\"navLinkScroll\" href=\"format.php?bhashya=" . $_POST['bid'] . "&page=" . $page_num . "#".$section['id']."\" data-index=\"#" . $section['id'] . ";" . $page_num . ";" . $_POST['bhashya'] . ";" . $_POST['hval'] . ";" . $_POST['level'] . "\">· " . $sName . "</a></li>";
	}
	echo "</ul></li>";
}
