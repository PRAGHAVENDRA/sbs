...
if($num_rows_l1)
{
	for($i_l1=1;$i_l1<=$num_rows_l1;$i_l1++)
	{
		...
		echo "<li class=\"sml\"><a class=\"navLinkScroll sml\" href=\"format.php?bhashya=BS&page=" . $page_num . "#".$id."\" data-index=\"#" . $id . ";" . $page_num . ";" . $bid . ";;4\">" . convert_devanagari($i_l1) . ". " . $title . "</a></li>";
	}
}
?>
